    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.TextField(help_text='The serialization format used by this model.')),
                ...
                ('db', models.TextField(help_text='The database the model under version control is stored in.')),
            ],
            options={
                "ordering": ("-pk",)
            },
